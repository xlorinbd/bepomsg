...
// pcntl is typically unavailable on Windows and is not required for web requests.
if (PHP_OS_FAMILY !== 'Windows' && php_sapi_name() === 'cli' && ! extension_loaded('pcntl')) {
    echo "ERROR: The requested PHP pcntl extension is missing from your system.<br />";
    exit(0);
}
