...
@section('content')
        ...
        <div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
            <div class="card mt-2">
                <div class="card-header border-bottom flex-column align-items-center">
                    <h2 class="card-title mb-1 text-primary fw-bolder">{{ __('locale.labels.privacy_policy') }}</h2>
                ...
                <div class="card-body mt-2">
                    <div id="policy-en" class="policy-content animate__animated animate__fadeIn" style="line-height: 1.6;">
                        {!! $privacyPolicyData !!}
                    </div>

                    <div id="policy-bn" class="policy-content animate__animated animate__fadeIn" style="display: none; line-height: 1.6; font-family: 'Noto Serif Bengali', serif !important;">
                        {!! $privacyPolicyDataBN !!}
                    </div>
    ...
    @push('page-style')
        ...
        <style>
            ...
            #policy-bn p, #policy-bn span, #policy-bn li {
                font-family: 'Noto Serif Bengali', serif !important;
                line-height: 1.8 !important;
            }
        </style>
    ...
    <script>
        function switchLang(lang) {
            const enContent = document.getElementById('policy-en');
            const bnContent = document.getElementById('policy-bn');
