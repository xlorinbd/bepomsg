                            ...
                            <div class="card-body">
                                ...
                                @switch($server['settings'])
                                    ...
                                    @case(SendingServer::TYPE_CHEAPGLOBALSMS)
                                        <p>Login with your CheapSMSGlobal portal then click on <code>2-Way-SMS -> Campaigns: Listeners & Forwarders</code> option. Finally insert this URL <code>{{ route('inbound.cheapglobalsms') }}</code> on your <code>Callback URL</code> field</p>
                                        @break
                                    ...
                                    @case(SendingServer::TYPE_VOXIMPLANT)
                                        <p>To receive inbound sms, go to the Voximplant control panel's Webhooks section and click Add in the middle of the screen. The two text fields appear: Callback URL and Security salt. In the Callback URL, specify the URL <code>{{ route('inbound.voximplant') }}</code> and click Save.</p>
                                        @break
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_PMCSMS)
                                        ...
                                        @if($server['settings'] == 'Bandwidth' || $server['settings'] == 'RouteeNet' || $server['settings'] == 'KeccelSMS' || $server['settings'] == 'GlobalSMSCN' || $server['settings'] == 'OnBuka' || $server['settings'] == 'BulkGate' || $server['settings'] == SendingServer::TYPE_PICKYASSIST)
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_ORANGE)
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label class="form-label required" for="c1">Authorization Header</label>
                                                    <input type="text" id="c1"
                                                           class="form-control @error('c1') is-invalid @enderror"
                                                           value="{{ $server['c1'] }}" name="c1" required>
                                                    @error('c1')
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_VOXIMPLANT)
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_INFOBIP || $server['settings'] == SendingServer::TYPE_NIMBUZ || $server['settings'] == SendingServer::TYPE_OZONESMS)

                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="c1">{{ __('locale.labels.entity_id') }}</label>
                                                    <input type="text" id="c1"
                                                           class="form-control @error('c1') is-invalid @enderror"
                                                           value="{{ $server['c1'] }}" name="c1">
                                                    @error('c1')
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_SMPP)
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="c1" class="form-control @error('c1') is-invalid @enderror" value="{{ $server['c1'] }}" name="c1">
                                                    @error('c1')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="d-flex justify-content-start flex-wrap col-12">
                                            ...
                                            @if($server['settings'] == 'Twilio' || $server['settings'] == 'Plivo' || $server['settings'] == 'Vonage' || $server['settings'] == 'Infobip' || $server['settings'] == 'MessageBird' || $server['settings'] == SendingServer::TYPE_BULKSMSPROVIDERNG || $server['settings'] == 'Telnyx' || $server['settings'] == SendingServer::TYPE_AIRTELINDIA)
                                            ...
                                            @if($server['settings'] == 'Twilio' || $server['settings'] == 'TwilioCopilot' || $server['settings'] == 'Clickatell_Touch' || $server['settings'] == 'Clickatell_central' || $server['settings'] == 'TextLocal' || $server['settings'] == 'Plivo' || $server['settings'] == 'PlivoPowerpack' || $server['settings'] == 'BulkSMS' || $server['settings'] == 'SMSGlobal' || $server['settings'] == 'Vonage' || $server['settings'] == 'MessageBird' || $server['settings'] == 'WhatsAppChatApi' || $server['settings'] == 'SignalWire' || $server['settings'] == 'Telnyx' || $server['settings'] == 'Bandwidth' || $server['settings'] == 'Infobip' || $server['settings'] == 'Tyntec' || $server['settings'] == 'EasySendSMS' || $server['settings'] == 'Skyetel' || $server['settings'] == 'Callr' || $server['settings'] == 'CMCOM' || $server['settings'] == 'Whatsender' || $server['settings'] == 'Gatewayapi' || $server['settings'] == 'VisionUp' || $server['settings'] == 'Solucoesdigitais' || $server['settings'] == SendingServer::TYPE_TELEAPI || $server['settings'] == SendingServer::TYPE_CLICKSEND || $server['settings'] == SendingServer::TYPE_CHEAPGLOBALSMS || $server['settings'] ==  SendingServer::TYPE_SMSMODE || $server['settings'] ==  SendingServer::TYPE_VOXIMPLANT)
