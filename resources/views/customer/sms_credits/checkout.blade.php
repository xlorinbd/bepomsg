...
@section('title', 'Checkout - Buy SMS')
                    ...
                    <div class="step" data-target="#cart" role="tab" id="cart-trigger">
                        <button type="button" class="step-trigger">
                            ...
                            <span class="bs-stepper-label">
                                ...
                                <span class="bs-stepper-subtitle">SMS Credits</span>
                            </span>
                        </button>
                    </div>
                    <div class="line">
                ...
                <div class="bs-stepper-content">
                    ...
                    <div id="cart" class="content" role="tabpanel" aria-labelledby="cart-trigger">
                        <div class="content-header">
                            <h5 class="mb-0">Buy SMS</h5>
                            <small>Purchase SMS credits for your account</small>
                        </div>
                        <div class="row mt-1 mb-1">
                            <h5>SMS Quantity: <span class="text-primary">{{ number_format($quantity) }} SMS</span></h5>
                            <h5>Rate: <span class="text-primary">৳{{ number_format($rate, 2) }} per SMS</span></h5>
                            <h5>{{ __('locale.labels.total_price') }}: <span
                                    class="text-primary">৳{{ number_format($amount, 2) }}</span></h5>
                        </div>
                                ...
                                <div class="mb-1">
                                    ...
                                    <select class="form-select select2" id="country" name="country">
                                        @foreach(\App\Helpers\Helper::countries() as $country)
                                            <option value="{{$country['name']}}" {{ Auth::user()->customer->country == $country['name'] ? 'selected' : null }}>
                                                {{ $country['name'] }}
                                            </option>
                                        @endforeach
                                    </select>
                    ...
                    <div id="payment" class="content" role="tabpanel" aria-labelledby="payment-trigger">
                                ...
                                @foreach($payment_methods as $method)
                                    <li class="py-50">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="{{$method->type}}"> {{ $method->name }}
                                            </label>
                                        </div>
                                    </li>
                                @endforeach
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <input type="hidden" value="{{ $quantity }}" name="sms_unit">
                            <input type="hidden" value="{{ $amount }}" name="balance">
                            <input type="hidden" value="sms_credit" name="purchase_type">
