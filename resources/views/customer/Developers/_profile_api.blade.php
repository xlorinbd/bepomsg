<div class="text-uppercase text-primary font-medium-2 mb-3">{{ __('locale.labels.profile') }}
    {{ __('locale.labels.api') }}</div>
...
<div class="mt-4 mb-1 font-medium-2 text-primary">SMS Credit Balance</div>
<p class="font-medium-2 mt-2">{{ __('locale.developers.api_endpoint') }}</p>
...
<p>Returns balance object if the request was successful. </p>
<pre>
                                <code class="language-json">
{
    "status": "success",
    "data": {
        "sms_credit_balance": 1500,
        "expired_on": "2026-04-15 23:59:59"
    }
}
                                </code>
                            </pre>
