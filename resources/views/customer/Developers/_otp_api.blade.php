<div class="text-uppercase text-primary font-medium-2 mb-3">{{ __('locale.developers.otp_api') }}</div>
        ...
        <tbody>
            <tr>
                ...
                <td>When calling our API, send your api token with the authentication type set as <code>Bearer</code>
                    (Example: <code>Authorization: Bearer {api_token}</code>)</td>
            </tr>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>string</td>
                <td>The sender of the message. This can be a telephone number (including country code) or an
                    alphanumeric string. In case of an alphanumeric string, the maximum length is 11 characters.</td>
            </tr>
            ...
            <tr>
                ...
                <td>string</td>
                <td>The type of the message. For text message you have to insert <code>otp</code> as sms type.</td>
            </tr>
