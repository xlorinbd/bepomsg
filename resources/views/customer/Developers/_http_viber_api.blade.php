<div class="text-uppercase text-primary font-medium-2 mb-3">{{ __('locale.developers.viber_api') }}</div>
...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td>string</td>
            <td>The type of the message. For text message you have to insert <code>viber</code> as sms type.</td>
        </tr>
