            ...
            <div class="col-sm-6 mt-sm-0 mt-2">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <strong>{{ \App\Library\Tool::format_price($invoice->amount, $invoice->currency->format) }}</strong>
                        </td>
                    </tr>
                ...
                <div class="invoice-total-wrapper">
                    ...
                    <div class="invoice-total-item">
                        <p class="invoice-total-title">{{ __('locale.labels.tax') }}
                            ({{\App\Library\Tool::calculateTaxPercentage($invoice->amount, $invoice->tax)}}%):</p>
