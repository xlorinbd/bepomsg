                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td> {{ \App\Library\Tool::format_price($taxAmount, $subscription->plan->currency->format) }} </td>
                                    </tr>

                                    <tr>
                                        <td> {{ __('locale.labels.total_price') }}  </td>
                                        <td> {{ \App\Library\Tool::format_price($totalAmount, $subscription->plan->currency->format) }} </td>
                                    </tr>
