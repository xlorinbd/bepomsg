        ...
        <div class="row match-height">
            <div class="col-12">
                ...
                <ul class="nav nav-pills mb-2 text-uppercase" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  @if (old('tab') == 'invoice' || old('tab') == null) active @endif"
                            id="invoice-tab" data-bs-toggle="tab" aria-controls="invoice" href="#invoice" role="tab"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ old('tab') == 'preferences' ? 'active' : 'invoice' }}" id="preferences-tab"
                            data-bs-toggle="tab" aria-controls="preferences" href="#preferences" role="tab"
                            aria-selected="false"> <i data-feather="settings"></i> {{__('locale.labels.preferences')}} </a>
                    </li>
                    @endif
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane  @if (old('tab') == 'invoice' || old('tab') == null) active @endif" id="invoice"
                        role="tabpanel" aria-labelledby="invoice-tab">
