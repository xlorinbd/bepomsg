                        ...
                        <div class="row invoice-sales-total-wrapper">
                            ...
                            <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                <div class="invoice-total-wrapper">
                                    ...
                                    @if($invoice->transaction_charge > 0)
                                        <div class="invoice-total-item">
                                            <p class="invoice-total-title">{{ $invoice->paymentMethod->name }} {{ __('locale.labels.transaction_charge') }} ({{ $invoice->transaction_charge_rate }}%):</p>
                                            <p class="invoice-total-amount">{{ Tool::format_price($invoice->transaction_charge, $invoice->currency->format) }}</p>
                                        </div>
                                    @endif
                                    <div class="invoice-total-item">
                                    ...
                                    <div class="invoice-total-item">
                                        ...
                                        <p class="invoice-total-amount">{{ Tool::format_price($invoice->total_amount ?? ($invoice->amount + $invoice->tax + ($invoice->transaction_charge ?? 0)), $invoice->currency->format) }}</p>
