                                            ...
                                            <div class="mb-1">
                                                ...
                                                <select class="select2-icons form-select" name="capabilities[]"
                                                    ...
                                                    <option value="sms" data-icon="message-square"
                                                            selected>{{ __('locale.labels.sms') }}</option>
                                                    <option value="voice"
                                                            data-icon="phone-call">{{ __('locale.labels.voice')}} </option>
                                                    <option value="mms"
                                                            data-icon="image">{{ __('locale.labels.mms')}} </option>
                                                    <option value="whatsapp"
                                                            data-icon="message-circle">{{ __('locale.labels.whatsapp')}} </option>
                                                    <option value="viber"
                                                            data-icon="tablet">{{ __('locale.menu.Viber')}} </option>
                                                    <option value="otp"
                                                            data-icon="unlock">{{ __('locale.menu.OTP')}} </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" id="price"
                                                       ...
                                                       value="{{ old('price') ? old('price') : 0 }}" name="price"
