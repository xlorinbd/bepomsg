        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    @if($campaign->status == \App\Models\Campaigns::STATUS_DELIVERED)
                        <h5 class="mb-1">{{ __('locale.labels.delivered_at') }}: <span class="fw-bold"> {{ \App\Library\Tool::customerDateTime($campaign->delivery_at) }}</span></h5>
                    @endif
