                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                ...
                                                <select class="form-select" name="allocation_type" id="allocation_type">
                                                    <option value="shared" {{ isset($senderid->allocation_type) && $senderid->allocation_type == 'shared' ? 'selected' : null }}>Shared</option>
                                                    <option value="dedicated" {{ isset($senderid->allocation_type) && $senderid->allocation_type == 'dedicated' ? 'selected' : null }}>Dedicated</option>
                                                </select>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                ...
                                                <select class="form-select select2" id="sending_servers" name="sending_servers[]"
                                                        multiple>
                                                    @php
                                                        $selected_servers = $senderid->sendingServers->pluck('id')->toArray();
                                                    @endphp
                                                    @foreach($sending_servers as $server)
                                                        <option value="{{$server->id}}" {{ in_array($server->id, $selected_servers) ? 'selected' : '' }}>{{$server->name}}</option>
                                                    @endforeach
                                                </select>
