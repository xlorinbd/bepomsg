            ...
            <ul class="nav navbar-nav">
                @if(Auth::user()->active_portal == 'customer' && Auth::user()->is_customer == 1 && Auth::user()->customer->activeSubscription())
                    <li class="nav-item"><a class="navbar-brand" href="{{route('user.home')}}">
                            <span class="brand-logo"><img src="{{asset(Helper::app_config('app_logo'))}}" alt="app logo"/></span>
                        </a>
                    </li>
                @else
                    ...
                    <ul class="nav navbar-nav align-items-center ms-auto">
                        ...
                        @if(Auth::user()->active_portal == 'admin' && Auth::user()->is_admin == 1)
                            <li class="nav-item d-none d-lg-block me-1">
                                <a href="{{ route('admin.server-balance.index') }}" class="btn btn-sm btn-success text-white" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Check Server Balance">
                                    <i data-feather="activity" class="me-25"></i>
                                    <span>Server Balance</span>
                                </a>
                            </li>
                            <li class="nav-item d-none d-lg-block me-1">
                                <a href="{{ route('admin.settings.clear_cache') }}" class="btn btn-sm btn-info text-white" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Clear Application Cache">
                        ...
                        <li class="dropdown dropdown-user nav-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                                ...
                                @if(Auth::user()->active_portal == 'customer' && Auth::user()->is_customer == 1)
                                    <a class="dropdown-item" href="{{route('customer.buy_sms.index')}}">
