<?php
    ...
    class EloquentUserRepository extends EloquentBaseRepository implements UserRepository
    {
        ...
        {
            /** @var User $user */
            $user = $this->make(Arr::only($input, [
                'first_name', 'last_name', 'email', 'status', 'phone', 'username', 'gender', 'nid_number',
                'date_of_birth', 'company_name', 'company_address', 'purpose_of_use', 'nid_upload', 'trade_license', 'image',
            ]));
