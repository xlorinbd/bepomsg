        ...
        if ($paymentMethod) {
            ...
            switch ($paymentMethod->type) {
                ...
                case PaymentMethods::TYPE_PAYSTATION:
                    ...
                    $post_data['reference'] = $item_name;
                    $post_data['checkout_items'] = $item_name;
                    $post_data['callback_url'] = route('customer.callback.paystation.subscriptions', [
                        'plan' => $plan->uid,
                        'invoice_number' => $paystation_invoice,
                    ]);
        ...
        if ($paymentMethod) {
            ...
            switch ($paymentMethod->type) {
                ...
                case PaymentMethods::TYPE_PAYSTATION:
                    ...
                    $post_data['merchantId'] = $credentials->merchantId;
                    $post_data['password'] = $credentials->password;
                    $post_data['invoice_number'] = $user->uid . '-' . $plan->uid;
                    $post_data['currency'] = $plan->currency->code;
                    $post_data['payment_amount'] = $price;
                    $post_data['cust_name'] = $input['first_name'];
                    $post_data['cust_email'] = $input['email'];
                    ...
                    $post_data['reference'] = $item_name;
                    $post_data['checkout_items'] = $item_name;
                    $post_data['callback_url'] = route('user.callback.paystation.register', ['user' => $user->uid, 'plan' => $plan->uid]);
